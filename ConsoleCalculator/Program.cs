...
while (!endApp)
{
    // Declare varaibles and set to empty
    string numInput1 = "";
    string numInput2 = "";
    double result = 0;
    ...
    Console.WriteLine("Press 'n' and Enter to close the app, or press any other key and Enter to contine: ");
    if (Console.ReadLine() == "n") endApp = true;

    Console.WriteLine("\n"); // Freindly linespacing
}
